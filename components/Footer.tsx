      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <h2 className="font-space font-black text-5xl mb-6 italic text-primary tracking-tighter">TEXPERIA 2026</h2>
          ...
          <div>
            <h4 className="font-space font-black text-xl mb-6 tracking-tight uppercase italic">LOCATION</h4>
